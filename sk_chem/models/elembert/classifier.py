...
from sk_chem.models.elembert.base import (
    Config,
    ElemBertEmbedding,
    create_elembert_model,
)
from sk_chem.models.elembert.tokenizer import EL2IDV1


class ElemBertClassifier(ElemBertEmbedding):
    def __init__(
        self,
    ...
    def make_model(self):
        ...
        f = layers.Dense(2, activation="softmax", name="out_tox")(e)
    ...
    def predict(self, X):
        return self._predict(X).argmax(axis=1)
